...
class ProvenanceLog:
    ...
    def update_dataset_counts(self, n_disease: int, n_control: int):
        """Update disease/control counts after sample group assignment."""
        if "dataset" in self.data:
            self.data["dataset"]["n_disease"] = n_disease
            self.data["dataset"]["n_control"] = n_control
            self._save()
